...
public class SpidIdentityProvider extends AbstractIdentityProvider<SpidIdentityProviderConfig> {
    ...
    public void backchannelLogout(KeycloakSession session, UserSessionModel userSession, UriInfo uriInfo, RealmModel realm) {
        ...
        try {
            ...
            if (!success) {
                logger.warn("Failed (spid) saml backchannel broker logout to: " + singleLogoutServiceUrl);
            }
        } catch (Exception e) {
            logger.warn("Failed (spid) saml backchannel broker logout to: " + singleLogoutServiceUrl, e);
        }
